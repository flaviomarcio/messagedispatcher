...
public:
    ...
    //! \return
    //!
    virtual const QMultiHash<QString,QVariant> toMultiHash(const QVariant&v);
    ...
    //! \return
    //!
    virtual const QMultiHash<QString,QVariant> toMultiHash(const QVariant&key, const QVariant&value);
    ...
    //! \return
    //!
    virtual const QVariant toType(int type, const QVariant&v=QVariant());
